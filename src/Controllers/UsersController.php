...
final class UsersController
{
    public function index(): never
    {
        $statement = Database::connection()
            ->query('select id, name, username, email, ban, is_active, type_admin, money, totalmoney, tongnapthang, created_at, updated_at from users order by id desc');
    ...
    {
        $statement = Database::connection()
            ->prepare('select id, name, username, email, ban, is_active, type_admin, money, totalmoney, tongnapthang, created_at, updated_at from users where id = :id');
    ...
    public function store(): never
    {
        ...
        $created = $connection->prepare(
            'select id, name, username, email, ban, is_active, type_admin, money, totalmoney, tongnapthang, created_at, updated_at from users where id = :id'
        );
