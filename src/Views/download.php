<section class="download-page">
    <header class="download-heading">
        ...
        <h1>Tải game</h1>
        <span class="download-current">Phiên bản dành cho: JAVA</span>
    </header>

    <div class="download-platforms">
        <details class="download-platform" open>
            <summary>
                <span class="download-platform-icon download-platform-icon-download">
                ...
                <span class="download-platform-copy">
                    <strong>JAVA</strong>
                    <small>Danh sách bản tải xuống mới nhất.</small>
                </span>
        ...
        <details class="download-platform" open>
            <summary>
                <span class="download-platform-icon download-platform-icon-android">
                    <svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M7.2 9.15h9.6c1.02 0 1.85.83 1.85 1.85v5.65c0 1.02-.83 1.85-1.85 1.85h-.55v1.75a1.25 1.25 0 1 1-2.5 0V18.5h-3.5v1.75a1.25 1.25 0 1 1-2.5 0V18.5H7.2a1.85 1.85 0 0 1-1.85-1.85V11c0-1.02.83-1.85 1.85-1.85Zm-3.1 1.2c.69 0 1.25.56 1.25 1.25v4.4a1.25 1.25 0 1 1-2.5 0v-4.4c0-.69.56-1.25 1.25-1.25Zm15.8 0c.69 0 1.25.56 1.25 1.25v4.4a1.25 1.25 0 1 1-2.5 0v-4.4c0-.69.56-1.25 1.25-1.25ZM8.17 5.1 6.95 3.88a.55.55 0 0 1 .78-.78L9.12 4.5A6.08 6.08 0 0 1 12 3.8c1.04 0 2.02.25 2.88.7l1.39-1.4a.55.55 0 0 1 .78.78L15.83 5.1a5.36 5.36 0 0 1 1.72 3H6.45a5.36 5.36 0 0 1 1.72-3Zm1.58 1.65a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm4.5 0a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Z"/></svg>
                </span>
                <span class="download-platform-copy">
                    <strong>Android</strong>
                    <small>Phiên bản APK dành cho điện thoại Android.</small>
                </span>
                <span class="download-platform-caret" aria-hidden="true">
                    <svg viewBox="0 0 24 24"><path fill="currentColor" d="M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41Z"/></svg>
                </span>
            ...
            <div class="download-version-grid">
                <article class="download-version-card">
                    <span class="download-version-icon download-version-icon-android">
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M7.2 9.15h9.6c1.02 0 1.85.83 1.85 1.85v5.65c0 1.02-.83 1.85-1.85 1.85h-.55v1.75a1.25 1.25 0 1 1-2.5 0V18.5h-3.5v1.75a1.25 1.25 0 1 1-2.5 0V18.5H7.2a1.85 1.85 0 0 1-1.85-1.85V11c0-1.02.83-1.85 1.85-1.85Z"/></svg>
                    </span>
                    <h2>Android 1.0.0</h2>
                    <dl>
                        <div>
        ...
        <details class="download-platform" open>
            <summary>
                <span class="download-platform-icon download-platform-icon-windows">
                    <svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M3 5.1 10.8 4v7.35H3V5.1Zm9-1.28L21 2.5v8.85h-9V3.82ZM3 12.65h7.8V20L3 18.9v-6.25Zm9 0h9v8.85l-9-1.28v-7.57Z"/></svg>
                </span>
                <span class="download-platform-copy">
                    <strong>Windows</strong>
                    <small>Phiên bản PC tải về chơi ngay.</small>
                </span>
                <span class="download-platform-caret" aria-hidden="true">
                    <svg viewBox="0 0 24 24"><path fill="currentColor" d="M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41Z"/></svg>
                </span>
            ...
            <div class="download-version-grid">
                <article class="download-version-card">
                    <span class="download-version-icon download-version-icon-windows">
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M3 5.1 10.8 4v7.35H3V5.1Zm9-1.28L21 2.5v8.85h-9V3.82ZM3 12.65h7.8V20L3 18.9v-6.25Zm9 0h9v8.85l-9-1.28v-7.57Z"/></svg>
                    </span>
                    <h2>Windows 1.0.0</h2>
                    <dl>
                        ...
                        <div>
                            <dt>Yêu cầu:</dt>
                            <dd>Windows 7 trở lên.</dd>
                        </div>
                    </dl>
                    <a class="btn primary download-version-button" href="/file/NINJASCHOOLBLUE.zip">Tải xuống</a>
                </article>
            </div>
        </details>
